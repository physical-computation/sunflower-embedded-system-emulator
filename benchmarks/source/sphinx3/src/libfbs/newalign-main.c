...
/* BHIKSHA: ADDING -nooptsil and -nooptfiller flags */
...
/* ADDED BY BHIKSHA: 6 JAN 98 */ 
    ...
    { "-nooptsil",
      ...
      CMD_LN_NO_VALIDATION,
      "no",
      "Do not hypothesize silences between words/beginning end of utt if yes" },
    { "-nooptfiller",
      CMD_LN_STRING,
      CMD_LN_NO_VALIDATION,
      "no",
      "Do not hypothesize filler between words/beginning end of utt if yes" },
    { "-ctlfn",
      CMD_LN_STRING,
      CMD_LN_NO_VALIDATION,
      CMD_LN_NO_DEFAULT,
