...
csuEBGMGraphFit $MODEL_LIST $NOVEL_IMAGE_LIST_LO $WAVELET $EBGM_SFI_DIR  $MODEL_GRAPH_DIR DEPredictiveIter $NOVEL_GRAPH_DIR > graphfit.lo.log &
csuEBGMGraphFit $MODEL_LIST $NOVEL_IMAGE_LIST_HI $WAVELET $EBGM_SFI_DIR  $MODEL_GRAPH_DIR DEPredictiveIter $NOVEL_GRAPH_DIR > graphfit.hi.log &
wait
...
csuEBGMMeasure $NOVEL_IMAGE_LIST $FACE_GRAPH_DIR FGPredictiveStep $FGPI_DIR
