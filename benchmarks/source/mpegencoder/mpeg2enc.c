/*************************************************************
 This program does the entire application a single chip 

 but models it in such a way that it is divided into partitions

 File modified by Koushik for partitioned mpeg implementation 
