...
#ifdef TRACE
    if ((Trace_Flag)&&((*macroblock_type & MACROBLOCK_INTRA)
    && concealment_motion_vectors))
      printf("\nNew_motion_vector_Intra ");
    if ((Trace_Flag)&&(*macroblock_type & MACROBLOCK_MOTION_FORWARD))
      printf("\nNew_motion_vector_Forward ");
#endif /* TRACE */
  }
