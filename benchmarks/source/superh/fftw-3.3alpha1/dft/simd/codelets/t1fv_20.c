...
/* Generated by: ../../../genfft/gen_twiddle_c -fma -reorder-insns -schedule-for-pipeline -simd -compact -variables 4 -pipeline-latency 8 -n 20 -name t1fv_20 -include t1f.h */
...
static const ct_desc desc = { 20, "t1fv_20", twinstr, &GENUS, {77, 42, 46, 0}, 0, 0, 0 };

void X(codelet_t1fv_20) (planner *p) {
     X(kdft_dit_register) (p, t1fv_20, &desc);
}
#else				/* HAVE_FMA */

/* Generated by: ../../../genfft/gen_twiddle_c -simd -compact -variables 4 -pipeline-latency 8 -n 20 -name t1fv_20 -include t1f.h */
...
static const ct_desc desc = { 20, "t1fv_20", twinstr, &GENUS, {111, 50, 12, 0}, 0, 0, 0 };
