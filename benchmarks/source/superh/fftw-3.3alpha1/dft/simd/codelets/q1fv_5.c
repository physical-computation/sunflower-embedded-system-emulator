...
/* Generated on Sat Nov 15 20:54:10 EST 2008 */

#include "codelet-dft.h"

#ifdef HAVE_FMA

/* Generated by: ../../../genfft/gen_twidsq_c -fma -reorder-insns -schedule-for-pipeline -simd -compact -variables 4 -pipeline-latency 8 -n 5 -dif -name q1fv_5 -include q1f.h */
...
static const ct_desc desc = { 5, "q1fv_5", twinstr, &GENUS, {55, 50, 45, 0}, 0, 0, 0 };

void X(codelet_q1fv_5) (planner *p) {
     X(kdft_difsq_register) (p, q1fv_5, &desc);
}
#else				/* HAVE_FMA */

/* Generated by: ../../../genfft/gen_twidsq_c -simd -compact -variables 4 -pipeline-latency 8 -n 5 -dif -name q1fv_5 -include q1f.h */
...
static const ct_desc desc = { 5, "q1fv_5", twinstr, &GENUS, {85, 55, 15, 0}, 0, 0, 0 };
