...
/* BHIKSHA: added "-nooptsil" and "-nooptfiller" flags */
     ...
     int32 append_filler)	/* Whether optional filler words to follow w */
{
    ...
    optfiller = (char *) cmd_ln_access("-nooptfiller");
/* HACK HACK HACK HACK HACK BHIKSHA OUCH!
    optsil = (char *) cmd_ln_access("-nooptsil");
*/
    if (strcmp(optfiller,"yes") == 0) prefix_filler = append_filler = 0;
