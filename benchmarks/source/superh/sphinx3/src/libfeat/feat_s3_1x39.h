/*
 * feat_s3_1x39.h -- Cepstral features computation for Sphinx-3 single-vector feature.
 *
 * **********************************************
...
#ifndef _LIBFEAT_FEAT_S3_1X39_H_
#define _LIBFEAT_FEAT_S3_1X39_H_
 ...
 */
int32 feat_s3_1x39_featsize (int32 **size); /* Out: Upon return, *size is a ptr to the
 ...
 */
void feat_s3_1x39_cep2feat (float32 **mfc,   /* In: Array of 2W+1 mfc vectors, CENTERED on
