/*
 * feat_1s_c_d_dd.h -- Cepstral features computation for Sphinx-3 single-vector feature.
 *
 * **********************************************
...
#ifndef _LIBFEAT_FEAT_1S_C_D_DD_H_
#define _LIBFEAT_FEAT_1S_C_D_DD_H_
 ...
 */
int32 feat_1s_c_d_dd_cepsize ( int32 veclen );
 ...
 */
int32 feat_1s_c_d_dd_featsize (int32 **size); /* Out: Upon return, *size is a ptr to the
 ...
 * Return value: W.
 */
int32 feat_1s_c_d_dd_window_size ( void );


/*
 * Compute feature vectors from a window of mfc frames.
 */
void feat_1s_c_d_dd_cep2feat (float32 **mfc,   /* In: Array of 2W+1 mfc vectors, CENTERED on
