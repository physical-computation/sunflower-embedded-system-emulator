/*
 * feat_1s_c.h -- Cepstral features computation for Sphinx-3 single-vector feature.
 *
 * **********************************************
...
#ifndef _LIBFEAT_FEAT_1S_C_H_
#define _LIBFEAT_FEAT_1S_C_H_
 ...
 */
int32 feat_1s_c_featsize (int32 **size); /* Out: Upon return, *size is a ptr to the
 ...
 */
void feat_1s_c_cep2feat (float32 **mfc,   /* In: Array of 2W+1 mfc vectors, CENTERED on
