/*
 * feat_1s_c_d_dd.c -- Cepstral feature stream; Sphinx3 version: single vector of
...
int32 feat_1s_c_d_dd_featsize (int32 **size)
{
    *size = feat_size;
    return N_FEAT;
}
...
void feat_1s_c_d_dd_cep2feat (float32 **mfc, float32 **feat)
{
    float32 *f;
    float32 *w, *_w;
