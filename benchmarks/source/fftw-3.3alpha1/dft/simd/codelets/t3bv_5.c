...
/* Generated on Sat Nov 15 20:52:46 EST 2008 */

#include "codelet-dft.h"

#ifdef HAVE_FMA

/* Generated by: ../../../genfft/gen_twiddle_c -fma -reorder-insns -schedule-for-pipeline -simd -compact -variables 4 -pipeline-latency 8 -twiddle-log3 -precompute-twiddles -no-generate-bytw -n 5 -name t3bv_5 -include t3b.h -sign 1 */
...
static const ct_desc desc = { 5, "t3bv_5", twinstr, &GENUS, {13, 14, 9, 0}, 0, 0, 0 };

void X(codelet_t3bv_5) (planner *p) {
     X(kdft_dit_register) (p, t3bv_5, &desc);
}
#else				/* HAVE_FMA */

/* Generated by: ../../../genfft/gen_twiddle_c -simd -compact -variables 4 -pipeline-latency 8 -twiddle-log3 -precompute-twiddles -no-generate-bytw -n 5 -name t3bv_5 -include t3b.h -sign 1 */
...
static const ct_desc desc = { 5, "t3bv_5", twinstr, &GENUS, {19, 15, 3, 0}, 0, 0, 0 };
