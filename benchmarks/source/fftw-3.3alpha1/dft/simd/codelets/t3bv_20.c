...
/* Generated on Sat Nov 15 20:52:48 EST 2008 */

#include "codelet-dft.h"

#ifdef HAVE_FMA

/* Generated by: ../../../genfft/gen_twiddle_c -fma -reorder-insns -schedule-for-pipeline -simd -compact -variables 4 -pipeline-latency 8 -twiddle-log3 -precompute-twiddles -no-generate-bytw -n 20 -name t3bv_20 -include t3b.h -sign 1 */
...
static const ct_desc desc = { 20, "t3bv_20", twinstr, &GENUS, {92, 72, 46, 0}, 0, 0, 0 };

void X(codelet_t3bv_20) (planner *p) {
     X(kdft_dit_register) (p, t3bv_20, &desc);
}
#else				/* HAVE_FMA */

/* Generated by: ../../../genfft/gen_twiddle_c -simd -compact -variables 4 -pipeline-latency 8 -twiddle-log3 -precompute-twiddles -no-generate-bytw -n 20 -name t3bv_20 -include t3b.h -sign 1 */
...
static const ct_desc desc = { 20, "t3bv_20", twinstr, &GENUS, {126, 80, 12, 0}, 0, 0, 0 };
