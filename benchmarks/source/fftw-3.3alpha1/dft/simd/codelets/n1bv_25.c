...
/* Generated on Sat Nov 15 20:44:46 EST 2008 */

#include "codelet-dft.h"

#ifdef HAVE_FMA

/* Generated by: ../../../genfft/gen_notw_c -fma -reorder-insns -schedule-for-pipeline -simd -compact -variables 4 -pipeline-latency 8 -sign 1 -n 25 -name n1bv_25 -include n1b.h */
...
static const kdft_desc desc = { 25, "n1bv_25", {43, 12, 181, 0}, &GENUS, 0, 0, 0, 0 };
void X(codelet_n1bv_25) (planner *p) {
     X(kdft_register) (p, n1bv_25, &desc);
}

#else				/* HAVE_FMA */

/* Generated by: ../../../genfft/gen_notw_c -simd -compact -variables 4 -pipeline-latency 8 -sign 1 -n 25 -name n1bv_25 -include n1b.h */
...
static const kdft_desc desc = { 25, "n1bv_25", {147, 63, 77, 0}, &GENUS, 0, 0, 0, 0 };
void X(codelet_n1bv_25) (planner *p) {
     X(kdft_register) (p, n1bv_25, &desc);
}
