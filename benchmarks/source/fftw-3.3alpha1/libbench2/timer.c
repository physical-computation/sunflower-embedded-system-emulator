...
/*
	pip: BEGIN: added for sunflowersim
*/
typedef unsigned long mytime;
extern unsigned long devrtc_getusecs(void);

static mytime get_time(void)
{
     return devrtc_getusecs();
}

static double elapsed(mytime t1, mytime t0)
{
     return ((double)t1 - (double)t0) * 1.0E-6;
}
#define HAVE_TIMER
/*
	pip: END: added for sunflowersim
*/
