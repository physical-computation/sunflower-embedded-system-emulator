...
//	TODO: the sh7708.h what is currently in sys/kern.h should be generated
//	automatically from this header during make, so we don't have to keep
//	editing both each time we add a new mem mapped register
